...
def floating_ip_get_pools_usage(context):
    return IMPL.floating_ip_get_pools_usage(context)


def floating_ip_get_pools_capacity(context):
    return IMPL.floating_ip_get_pools_capacity(context)
...
def floating_ip_count_by_project_type(context, project_id, is_private,
    ...
    return IMPL.floating_ip_count_by_project_type(context, project_id,
                                is_private, private_pools, session=session)
...
def floating_ip_get_allocated(context):
    ...
    return IMPL.floating_ip_get_allocated(context)
...
def fixed_ip_associate_pool_in_subnet(context, network_id, subnet_cidr,
    ...
    """
    return IMPL.fixed_ip_associate_pool_in_subnet(context, network_id,
                                                  subnet_cidr, start_ip,
                                                  instance_uuid, host)
...
def fixed_ip_get_all_allocated(context):
    """Get all allocated fixed ips"""
    return IMPL.fixed_ip_get_all_allocated(context)
...
def instance_get_all_by_image_ref(context, image_ref):
    """Get usage of image by accounting intances which is using this image."""
    return IMPL.instance_get_all_by_image_ref(context, image_ref)
...
def instance_get_all_by_project_with_session(context, project_id, session):
    """Get all instances belonging to a project with given session."""
    return IMPL.instance_get_all_by_project_with_session(context,
                                                project_id, session)


def instance_get_all_by_project_include_fixed_ip(context, project_id):
    """Get all instances include fixed_ip info which belong to a project """
    return IMPL.instance_get_all_by_project_include_fixed_ip(context,
                                                project_id)
...
def instance_get_all_by_host_with_fixed_ip(context, host):
    """Get all instance belonging to a host with fixed ip information."""
    return IMPL.instance_get_all_by_host_with_fixed_ip(context, host)
...
def key_pair_get_all(context):
    ...
    return IMPL.key_pair_get_all(context)
...
def key_pair_update_fingerprint(context, user_id, name, fingerprint):
    """Update fingerprint by user_id and key pair name."""
    return IMPL.key_pair_update_fingerprint(context, user_id,
                                            name, fingerprint)
...
def quota_get_all(context):
    """Retrieve all quotas"""
    return IMPL.quota_get_all(context)
...
def quota_usage_get_all(context):
    """Retrieve all usage"""
    return IMPL.quota_usage_get_all(context)
...
def block_device_mapping_get_all_by_volume(context, volume_id):
    ...
    return IMPL.block_device_mapping_get_all_by_volume(context, volume_id)
...
def instance_metadata_get_item(context, instance_uuid, key):
    """Get all metadata for an instance filter by key."""
    return IMPL.instance_metadata_get_item(context, instance_uuid, key)
...
def instance_system_metadata_extension_get(context, instance_uuid):
    """Get all system metadata extension for an instance."""
    return IMPL.instance_system_metadata_extension_get(context, instance_uuid)


def instance_system_metadata_extension_delete(context, instance_uuid, key):
    """Delete the given system metadata extension item."""
    IMPL.instance_system_metadata_extension_delete(context, instance_uuid, key)


def instance_system_metadata_extension_update(context, instance_uuid, metadata,
                                              delete):
    """Update metadata extension if it exists, otherwise create it."""
    IMPL.instance_system_metadata_extension_update(
            context, instance_uuid, metadata, delete)
...
def public_bandwidth_count_by_project(context, project_id, session=None):
    return IMPL.public_bandwidth_count_by_project(context, project_id,
                                                  session=None)


def private_bandwidth_count_by_project(context, project_id, session=None):
    return IMPL.private_bandwidth_count_by_project(context, project_id,
                                                   session=None)
