...
class SecurityGroupControllerBase(object):
    ...
    def _authorize_context(self, req, action=None):
...
class SecurityGroupController(SecurityGroupControllerBase):
    ...
    def show(self, req, id):
        ...
        context = self._authorize_context(req, action='show')
    ...
    def delete(self, req, id):
        ...
        context = self._authorize_context(req, action='delete')
    ...
    def index(self, req):
        ...
        context = self._authorize_context(req, action='index')
    ...
    def create(self, req, body):
        ...
        context = self._authorize_context(req, action='create')
...
class SecurityGroupRulesController(SecurityGroupControllerBase):
    ...
    def create(self, req, body):
        context = self._authorize_context(req, action='create_rule')
    ...
    def delete(self, req, id):
        context = self._authorize_context(req, action='delete_rule')
...
class SecurityGroupActionController(wsgi.Controller):
    ...
    def _get_sec_groups(self, body, action):
        """ Get group list from body.
            Body example:
                {"setSecurityGroups": ["sec1", "sec2"]}
        """
        try:
            groups = body[action]
        except KeyError:
        ...
        if not isinstance(groups, list):
            msg = _("Security group names must in a list ")
            raise webob.exc.HTTPBadRequest(explanation=msg)
    ...
    def _addSecurityGroup(self, req, id, body):
        context = req.environ['nova.context']
        authorize(context, action='add_to_server')
    ...
    def _removeSecurityGroup(self, req, id, body):
        context = req.environ['nova.context']
        authorize(context, action='remove_from_server')
    ...
    @wsgi.action('setSecurityGroups')
    def _setSecurityGroup(self, req, id, body):
        context = req.environ['nova.context']
        authorize(context, action='set_to_server')

        groups = self._get_sec_groups(body, 'setSecurityGroups')

        return self._invoke(self.security_group_api.ensure_to_instance,
                            context, id, groups)
