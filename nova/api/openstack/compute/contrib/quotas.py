...
authorize_index = extensions.extension_authorizer('compute', 'quotas:index')
...
class QuotaSetsController(object):
    ...
    def index(self, req):
        '''
        list quotas of all projects which has usages or has updated quotas.
        '''
        context = req.environ['nova.context']
        authorize_index(context)
        try:
            return QUOTAS.get_quotas(context, usages=True)
    ...
    def update(self, req, id, body):
        ...
        project_id = id
        if not wsgi.Controller.is_valid_body(body, 'quota_set'):
