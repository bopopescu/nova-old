...
class FilterScheduler(driver.Scheduler):
    ...
    def schedule_prep_resize(self, context, image, request_spec,
                             ...
                             reservations, keep_ephemeral=True):
        ...
        self.compute_rpcapi.prep_resize(context, image, instance,
                                        ...
                                        reservations, keep_ephemeral)

    def schedule_relocate(self, context, request_spec,
                          filter_properties, instance, image):
        """Select a target for relocate. """
        hosts = self._schedule(context, 'compute', request_spec,
                               filter_properties, [instance['uuid']])
        if not hosts:
            raise exception.NoValidHost(reason="")
        ...
        self.compute_rpcapi.relocate_instance(context, instance, image,
    ...
    def _provision_resource(self, context, weighted_host, request_spec,
        ...
        avail_zone = weighted_host.host_state.service.get('availability_zone')
        updated_instance = driver.instance_update_db(context,
                instance_uuid, weighted_host.host_state.host, avail_zone)
