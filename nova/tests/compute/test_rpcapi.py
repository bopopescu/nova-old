...
class ComputeRpcAPITestCase(test.TestCase):
    ...
    def test_add_aggregate_host(self):
        self._test_compute_api('add_aggregate_host', 'cast', aggregate_id='id',
                host_param='host', host='host', subordinate_info={}, version='2.2')
    ...
    def test_finish_resize(self):
        self._test_compute_api('finish_resize', 'cast',
                ...
                reservations=list('fake_res'), keep_ephemeral=True)
    ...
    def test_relocate_instance(self):
        self._test_compute_api('relocate_instance', 'cast',
                instance=self.fake_instance, host='fake_host', image=None,
                reservations=None)

    def test_pre_relocate_instance(self):
        self._test_compute_api('pre_relocate_instance', 'call',
                instance=self.fake_instance, reservations=None)
