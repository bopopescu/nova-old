...
class VolumeTypesApiTest(test.TestCase):
    ...
    def test_view_builder_show(self):
        ...
        expected_volume_type = dict(name='new_type',
                                    extra_specs={},
                                    id=42)
        self.assertThat(output['volume_type'],
                        matchers.DictMatches(expected_volume_type))
    ...
    def test_view_builder_list(self):
        ...
        for i in range(0, 10):
            expected_volume_type = dict(name='new_type',
                                        extra_specs={},
                                        id=42 + i)
            self.assertThat(expected_volume_type,
                            matchers.DictMatches(output['volume_types'][i]))
