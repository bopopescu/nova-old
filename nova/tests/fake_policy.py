...
policy_data = """
{
    ...
    "compute:attach_nbs_volume": [],
    "compute:detach_nbs_volume": [],
    ...
    "compute:security_groups:ensure_to_instance": [],
    ...
    "compute_extension:admin_actions:relocate": [],
    "compute_extension:aggregates": [],
    "compute_extension:availability_zones": [],
    ...
    "compute_extension:extended_keypairs": [],
    ...
    "compute_extension:floating_ips:search": [["rule:admin_api"]],
    ...
    "compute_extension:keypairs:search": [["rule:admin_api"]],
    "compute_extension:multinic": [],
    "compute_extension:networks": [],
    "compute_extension:network-qos": [],
    "compute_extension:network-qos:index": [],
    "compute_extension:network-qos:update": [],
    "compute_extension:network-qos:show": [],
    "compute_extension:networks:view": [],
    "compute_extension:quotas:show": [],
    "compute_extension:quotas:update": [],
    "compute_extension:quotas:index": [],
    "compute_extension:quotas_usage": [["rule:admin_api"]],
    "compute_extension:quota_classes": [],
    "compute_extension:rescue": [],
    "compute_extension:security_groups": [],
    "compute_extension:security_groups:index": [],
    "compute_extension:security_groups:show": [],
    "compute_extension:security_groups:delete": [],
    "compute_extension:security_groups:create": [],
    "compute_extension:security_groups:create_rule": [],
    "compute_extension:security_groups:delete_rule": [],
    "compute_extension:security_groups:add_to_server": [],
    "compute_extension:security_groups:remove_from_server": [],
    "compute_extension:security_groups:set_to_server": [],
    "compute_extension:server_diagnostics": [],
    "compute_extension:server_status": [],
