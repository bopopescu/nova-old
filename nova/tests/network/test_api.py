...
class ApiTestCase(test.TestCase):
    ...
    def test_get_network_qos(self):
        ...
        res = self.network_api.get_network_qos(self.context, instance['id'])

        self.assertEqual('get_network_qos', res['method'])
        self.assertEqual(instance['id'], res['args']['instance_id'])
    ...
    def test_modify_network_qos(self):
        ...
        self.stubs.Set(rpc, 'call', fake_call)
        res = self.network_api.modify_network_qos(self.context, instance['id'],
                                                  qos_type, spec)

        self.assertEqual('modify_network_qos', res['method'])
        self.assertEqual(instance['id'], res['args']['instance_id'])
        self.assertEqual(qos_type, res['args']['qtype'])
