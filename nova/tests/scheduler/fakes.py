...
CPU_INFO = '{"ecu_ratio": 4, "ecus": 10, "ecus_used": 20, "free_ecus": 80}'


COMPUTE_NODES = [
        dict(id=1, local_gb=1024, memory_mb=1024, vcpus=1,
             disk_available_least=512, free_ram_mb=512, vcpus_used=1,
             free_disk_mb=512, local_gb_used=0, cpu_info=CPU_INFO,
             private_network_mbps_used=50, public_network_mbps_used=100,
             total_private_network_mbps=250, total_public_network_mbps=300,
             service=dict(host='host1', disabled=False)),
        dict(id=2, local_gb=2048, memory_mb=2048, vcpus=2,
             disk_available_least=1024, free_ram_mb=1024, vcpus_used=2,
             free_disk_mb=1024, local_gb_used=0, cpu_info=CPU_INFO,
             private_network_mbps_used=50, public_network_mbps_used=100,
             total_private_network_mbps=250, total_public_network_mbps=300,
             service=dict(host='host2', disabled=True)),
        dict(id=3, local_gb=4096, memory_mb=4096, vcpus=4,
             disk_available_least=3072, free_ram_mb=3072, vcpus_used=1,
             free_disk_mb=3072, local_gb_used=0, cpu_info=CPU_INFO,
             private_network_mbps_used=50, public_network_mbps_used=100,
             total_private_network_mbps=250, total_public_network_mbps=300,
             service=dict(host='host3', disabled=False)),
        dict(id=4, local_gb=8192, memory_mb=8192, vcpus=8,
             disk_available_least=8192, free_ram_mb=8192, vcpus_used=0,
             free_disk_mb=8192, local_gb_used=0, cpu_info=CPU_INFO,
             private_network_mbps_used=150, public_network_mbps_used=200,
             total_private_network_mbps=250, total_public_network_mbps=300,
