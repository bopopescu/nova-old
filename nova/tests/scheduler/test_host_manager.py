...
class HostManagerTestCase(test.TestCase):
    ...
    def test_update_service_capabilities_node_key(self):
        ...
        expected = {'host1': {'compute': host1_cap},
    ...
    def test_get_all_host_states(self):
        ...
        self.assertEqual(host_states['host3'].private_network_mbps_used, 50)
        self.assertEqual(host_states['host3'].public_network_mbps_used, 100)
        self.assertEqual(host_states['host4'].private_network_mbps_used, 150)
        self.assertEqual(host_states['host4'].public_network_mbps_used, 200)
        self.assertEqual(host_states['host4'].total_private_network_mbps, 250)
        self.assertEqual(host_states['host4'].total_public_network_mbps, 300)
...
class HostStateTestCase(test.TestCase):
    ...
    def test_consume_network_bandwith_from_instance(self):
        fake_instance = {'private_network_bandwith': 15,
                         'public_network_bandwith': 25}

        fake_host = host_manager.HostState('host1', 'compute')
        fake_host.private_network_mbps_used = 20
        fake_host.public_network_mbps_used = 30

        fake_host._consume_network_bandwith_from_instance(fake_instance)

        self.assertEqual(35, fake_host.private_network_mbps_used)
        self.assertEqual(55, fake_host.public_network_mbps_used)
