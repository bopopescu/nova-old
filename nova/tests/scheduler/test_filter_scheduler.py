...
class FilterSchedulerTestCase(test_scheduler.SchedulerTestCase):
    ...
    def test_get_cost_functions(self):
        ...
        self.assertEquals(len(fns), 2)
        weight, fn1 = fns[0]
        self.assertEquals(weight, -1.0)
        weight, fn2 = fns[1]
        self.assertEquals(weight, 10.0)
        cpu_info = '{"ecu_ratio": 4, "ecus": 20, "ecus_used": 10}'
        ...
        hostinfo.update_from_compute_node(dict(memory_mb=1000,
                ...
                private_network_mbps_used=150,
                public_network_mbps_used=200,
                local_gb_used=0, cpu_info=cpu_info))
        self.assertEquals(872, fn1(hostinfo, {}))
        self.assertEquals(0, fn2(hostinfo, {"context": self.context}))
    ...
    def test_schedule_relocate(self):
        ...
        sched.schedule_relocate(fake_context, {}, {}, instance, None)
