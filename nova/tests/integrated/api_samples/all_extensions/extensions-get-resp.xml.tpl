...
<extensions xmlns:atom="http://www.w3.org/2005/Atom" xmlns="http://docs.openstack.org/common/api/v1.0">
  ...
  <extension alias="OS-EXT-AZ" updated="%(timestamp)s" namespace="not yet" name="ExtendedAvailabilityZone">
    <description>%(text)s</description>
  </extension>
  <extension alias="OS-EXT-IP" updated="%(timestamp)s" namespace="http://docs.openstack.org/compute/ext/os-ext-ip/api/v1.1" name="ExtendedHostIp">
    <description>%(text)s</description>
  </extension>
  <extension alias="OS-EXT-KP" updated="%(timestamp)s" namespace="not yet" name="ExtendedKeypairs">
    <description>%(text)s</description>
  </extension>
  ...
  <extension alias="availability-zones" updated="%(timestamp)s" namespace="not yet" name="AvailabilityZones">
    <description>%(text)s</description>
  </extension>
  <extension alias="os-action-failover" updated="%(timestamp)s" namespace="http://docs.openstack.org/compute/ext/action-failover/api/v1.1" name="ActionFailover">
    <description>%(text)s</description>
  </extension>
  ...
  <extension alias="os-floating-ips-search" updated="%(timestamp)s" namespace="http://docs.openstack.org/compute/ext/floating_ips/api/v1.1" name="FloatingIpsSearch">
    <description>%(text)s</description>
  </extension>
  ...
  <extension alias="os-keypairs-search" updated="%(timestamp)s" namespace="http://docs.openstack.org/compute/ext/keypairs/api/v1.1" name="KeypairsSearch">
    <description>%(text)s</description>
  </extension>
  ...
  <extension alias="os-network-qos" updated="%(timestamp)s" namespace="http://docs.openstack.org/compute/ext/network_qos/api/v1.1" name="NetworkQoS">
    <description>%(text)s</description>
  </extension>
  ...
  <extension alias="os-quotas-usage" updated="%(timestamp)s" namespace="http://docs.openstack.org/compute/ext/quotas-usage/api/v1.1" name="QuotasUsage">
    <description>%(text)s</description>
  </extension>
  ...
  <extension alias="os-server-status" updated="%(timestamp)s" namespace="http://docs.openstack.org/compute/ext/os-server-status/api/v1.1" name="ServerStatus">
    <description>%(text)s</description>
  </extension>
