...
class API(base.Base):
    ...
    def get_allocated_fixed_ips(self, context):
        return rpc.call(context,
                        FLAGS.network_topic,
                        {'method': 'get_allocated_fixed_ips'})
    ...
    def get_floating_ips(self, context, search_opts=None):
        return rpc.call(context,
                        FLAGS.network_topic,
                        {'method': 'get_floating_ips',
                        'args': dict(search_opts=search_opts)})
    ...
    def allocate_floating_ip(self, context, pool=None, assign_address=None):
    ...
    def get_network_qos(self, context, instance_id):
        """Get network qos for an instance """
        args = {'instance_id': instance_id}
        return rpc.call(context, FLAGS.network_topic,
                        {'method': 'get_network_qos',
                         'args': args})
    ...
    def create_instance_network_qos(self, context, instance_id,
        ...
        """create network for for an instance"""
        args = {
        ...
        return rpc.call(context, FLAGS.network_topic,
                        {'method': 'create_instance_network_qos',
                         'args': args})

    def create_address_network_qos(self, context, instance_id, qtype, atype,
                                   address):
        """create network for for an address"""
        args = {
                'instance_id': instance_id,
                'qtype': qtype,
                'atype': atype,
        ...
        return rpc.call(context, FLAGS.network_topic,
                        {'method': 'create_address_network_qos',
                         'args': args})

    def delete_instance_network_qos(self, context, instance_id, host,
                                    reserv_quota=False):
        """delete network qos for for an instance"""
        args = {
                'instance_id': instance_id,
                'host': host,
                'reserv_quota': reserv_quota,
               }
        return rpc.call(context, FLAGS.network_topic,
                        {'method': 'delete_instance_network_qos',
                         'args': args})
