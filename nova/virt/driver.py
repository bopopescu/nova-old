...
class ComputeDriver(object):
    ...
    def extend_nbs_volume(self, instance_name, device, size):
        """Extend the nbs disk attached to the instance"""
        raise NotImplementedError()

    def update_nbs_qos(self, instance_name, instance_uuid, device, qos_info):
        """Update the qos info of nbs disk attached to the instance"""
        raise NotImplementedError()

    def attach_nbs_volume(self, instance_name, instance_uuid, device, host_dev,
                          qos_info, volume_id):
        """Attach the nbs disk to the instance at mountpoint using info"""
        raise NotImplementedError()
    ...
    def detach_nbs_volume(self, instance_name, instance_uuid,
                          mountpoint, host_dev):
        """Detach the nbs disk attached to the instance"""
        raise NotImplementedError()
